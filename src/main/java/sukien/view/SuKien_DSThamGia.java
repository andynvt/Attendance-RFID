 ...
 * @author chuna
 */
public class SuKien_DSThamGia extends javax.swing.JPanel {
    ...
    public SuKien_DSThamGia(String mask) {
        initComponents();
        this.mask = mask;
        createUI();
    }
    ...
    private void createUI() {
        dSCanBo_View = new DSCanBo_View(mask);
        dSSinhVien_View = new DSSinhVien_View(mask);
    }
    ...
    public void showDSCanBo() {
        removeAll();
        add(dSCanBo_View = new DSCanBo_View(mask));
    ...
    public void showDSSinhVien() {
        removeAll();
        add(dSSinhVien_View = new DSSinhVien_View(mask));
